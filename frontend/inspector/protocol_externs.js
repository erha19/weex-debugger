 ...
 * @param {function(?Protocol.Error, !Array<!! Type not found: Debugger.SearchMatch>):void=} opt_callback
 */
...
/** @typedef {!{type:(Protocol.Network.InitiatorType), stack:(!! Type not found: Runtime.StackTrace|undefined), url:(string|undefined), lineNumber:(number|undefined)}} */
...
/** @typedef {!{key:(!! Type not found: Runtime.RemoteObject), primaryKey:(!! Type not found: Runtime.RemoteObject), value:(!! Type not found: Runtime.RemoteObject)}} */
...
/**
 * @param {!! Type not found: Runtime.RemoteObjectId} objectId
 * @param {function(?Protocol.Error, Protocol.DOM.NodeId):void=} opt_callback
 */
 ...
 * @param {!! Type not found: Runtime.RemoteObjectId=} opt_objectId
 * @param {function(?Protocol.Error):void=} opt_callback
 */
 ...
 * @param {function(?Protocol.Error, !! Type not found: Runtime.RemoteObject):void=} opt_callback
 */
...
/** @typedef {!{type:(string), useCapture:(boolean), passive:(boolean), once:(boolean), scriptId:(!! Type not found: Runtime.ScriptId), lineNumber:(number), columnNumber:(number), handler:(!! Type not found: Runtime.RemoteObject|undefined), originalHandler:(!! Type not found: Runtime.RemoteObject|undefined), removeFunction:(!! Type not found: Runtime.RemoteObject|undefined)}} */
...
/**
 * @param {string} animationId
 * @param {function(?Protocol.Error, !! Type not found: Runtime.RemoteObject):T} opt_callback
 * @return {!Promise.<T>}
 * @template T
 */
...
/** @typedef {!{source:(Protocol.Log.LogEntrySource), level:(Protocol.Log.LogEntryLevel), text:(string), timestamp:(!! Type not found: Runtime.Timestamp), url:(string|undefined), lineNumber:(number|undefined), stackTrace:(!! Type not found: Runtime.StackTrace|undefined), networkRequestId:(Protocol.Network.RequestId|undefined), workerId:(string|undefined)}} */
