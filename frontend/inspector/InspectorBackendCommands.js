...
InspectorBackend.registerEvent("Debugger.scriptParsed", ["scriptId", "url", "startLine", "startColumn", "endLine", "endColumn", "executionContextId", "hash", "executionContextAuxData", "isLiveEdit", "sourceMapURL", "hasSourceURL", "isModule"]);
InspectorBackend.registerEvent("Debugger.scriptFailedToParse", ["scriptId", "url", "startLine", "startColumn", "endLine", "endColumn", "executionContextId", "hash", "executionContextAuxData", "sourceMapURL", "hasSourceURL", "isModule"]);
...
InspectorBackend.registerCommand("Profiler.startPreciseCoverage", [], [], false);
InspectorBackend.registerCommand("Profiler.stopPreciseCoverage", [], [], false);
InspectorBackend.registerCommand("Profiler.takePreciseCoverage", [], ["result"], false);
